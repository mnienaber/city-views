...
//  let listingAddress: String
  let chelsea_hotel_lat = 40.74444
  let chelsea_hotel_long = -73.99667
//  let ace_hotel = [40.745778,-73.988285]

}

class ChelseaCoordinates {

  var latlong = ListingLocations()
}
...
////    updatedAt = updated
//    guard let chelsea_hotel_lat = dictionary[chelsea_hotel_lat] as? Double else { return nil }
//    chelsea_hotel_lat = chelsea_hotel_lat
//    guard let chelsea_hotel_long = dictionary[chelsea_hotel_long] as? Double else { return nil }
//    chelsea_hotel_long = chelsea_hotel_long
////    guard let ace_hotel = dictionary[ace_hotel] as? Double else { return nil }
////    ace_hotel = ace_hotel
//  }
